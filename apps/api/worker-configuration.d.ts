/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 9d13a7929f9549393b4a2d8b8cb1600c)
// Runtime types generated with workerd@1.20260611.1 2025-11-28 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	PUBLIC_RATE_LIMIT: RateLimit;
	CORE_API: Service /* entrypoint ApiEntrypoint from douban-bridge-core */;
}
