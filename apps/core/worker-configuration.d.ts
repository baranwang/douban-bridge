/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: d96fefe61efe4cad77226999ec0bb8b0)
// Runtime types generated with workerd@1.20260911.1 2025-11-28 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	KV: KVNamespace;
	STREMIO_ADDON_DOUBAN: D1Database;
	AGENT_MATCH_QUEUE: Queue;
	...
	TRAKT_CLIENT_ID: "95pidRr4d15bGI__HJQtIsSRzv_GfTnznlFotZrFsew";
	...
	AGENT_MATCH_BASE_URL: "https://api.openai.com/v1";
	AGENT_MATCH_MODEL: "gpt-4.1-mini";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOUBAN_API_KEY" | "TRAKT_CLIENT_ID" | "GITHUB_CLIENT_ID" | "STREMIO_ORIGIN" | "DASH_ORIGIN" | "AGENT_MATCH_BASE_URL" | "AGENT_MATCH_MODEL">> {}
}
