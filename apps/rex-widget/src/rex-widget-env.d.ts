...
type LoadDefaultCatalogParams =
  ...
  | MovieWeeklyBestLoadDefaultCatalogParams
  | MovieRealTimeHotestLoadDefaultCatalogParams
  | MovieTop250LoadDefaultCatalogParams
  | MovieShowingLoadDefaultCatalogParams
  | TvHotLoadDefaultCatalogParams
  | TvAnimationLoadDefaultCatalogParams
  | ShowHotLoadDefaultCatalogParams
  | TvRealTimeHotestLoadDefaultCatalogParams
  | TvChineseBestWeeklyLoadDefaultCatalogParams
  | TvGlobalBestWeeklyLoadDefaultCatalogParams
  | ShowChineseBestWeeklyLoadDefaultCatalogParams
  | ShowGlobalBestWeeklyLoadDefaultCatalogParams;
type LoadDefaultCatalogReturnType =
  | MovieHotGaiaLoadDefaultCatalogReturnType
  | MovieWeeklyBestLoadDefaultCatalogReturnType
  | MovieRealTimeHotestLoadDefaultCatalogReturnType
  | MovieTop250LoadDefaultCatalogReturnType
  | MovieShowingLoadDefaultCatalogReturnType
  | TvHotLoadDefaultCatalogReturnType
  | TvAnimationLoadDefaultCatalogReturnType
  | ShowHotLoadDefaultCatalogReturnType
  | TvRealTimeHotestLoadDefaultCatalogReturnType
  | TvChineseBestWeeklyLoadDefaultCatalogReturnType
  | TvGlobalBestWeeklyLoadDefaultCatalogReturnType
  | ShowChineseBestWeeklyLoadDefaultCatalogReturnType
  | ShowGlobalBestWeeklyLoadDefaultCatalogReturnType;

/** 豆瓣热门电影 */
declare let loadDefaultCatalog: (
  params: LoadDefaultCatalogParams,
) => LoadDefaultCatalogReturnType | null | Promise<LoadDefaultCatalogReturnType | null>;
...
/** 电影类型榜 */
declare let loadGenreCatalog: (
  params: LoadGenreCatalogParams,
) => LoadGenreCatalogReturnType | null | Promise<LoadGenreCatalogReturnType | null>;
...
/** 豆瓣年度评分最高电影 */
declare let loadYearlyCatalog: (
  params: LoadYearlyCatalogParams,
) => LoadYearlyCatalogReturnType | null | Promise<LoadYearlyCatalogReturnType | null>;
